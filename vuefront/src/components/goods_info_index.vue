<template>
	...
	<!-- 快速导航栏--start -->
		<div class="shortcut">
			<div class="w">
				...
				<ul class="fr ">
					<li>
						<a href="jingdong.html">你好，请登录</a>
						<a href="zhuce.html" class="f10">免费注册</a>
					</li>
					<li class="space"></li>
					<li>
	...
	<!-- 导航栏--start -->
		<div class="w middle">
			...
			<!-- 搜索框 -->
			<div class="form">			
				<input type="text" name="search" placeholder="手机" v-model="str">
				<button type="button" v-on:click="search()"><i></i></button>
			</div>
			<!-- 我的购物车 -->
			<div class="shopCar">
	...
	<!-- 页面底部--start -->
        ...
        <div align="center">
                    ...
                    :data="good.slice((currentPage-1)*pagesize,currentPage*pagesize)">
                        ...
                        <el-table-column label="商品库存" prop="goods_store" width="200" align="center">   
                        </el-table-column>   
						<el-table-column label="商品详情" prop="goods_detail" width="180" align="center">   
                        </el-table-column>
                        <el-table-column label="商家名称" prop="goods_shop" width="180" align="center">  
                        </el-table-column>
