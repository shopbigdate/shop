...
public class GoodsInfoImpl implements GoodsInfoService{
	@Autowired GoodsInfoMapper goodMapper;
	...
	public GoodsInfo getOneGoodsInfo(Integer goods_id) {	
		return goodMapper.getOneGoodsInfo(goods_id);
	}
	...
	public List<GoodsPicture> getOneGoodsPicture(Integer goods_id) {
		return goodMapper.getOneGoodsPicture(goods_id);
	}
	...
	public Integer createShoppingCar(ShoppingCar shoppingcar) {	
		HashMap<String, Integer> map = new HashMap<String, Integer>();
		 ...
		 goodMapper.createShoppingCar(map);
